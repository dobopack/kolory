...
function index() {
  return (
    <Section className={classes.wrapper}>
      ...
      <h2>
        Informacja o zasadach przetwarzania danych osobowych w Dobopack Trading
        Sp. z o.o.
      </h2>
      <p>
        Artykuł 13 Rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679
        z 27 kwietnia 2016 r. w sprawie ochrony osób fizycznych w związku z
        przetwarzaniem danych osobowych i w sprawie swobodnego przepływu takich
        danych oraz uchylenia dyrektywy 95/46/WE (dalej: RODO) zobowiązuje nas,
        czyli Dobopack Trading Sp. z o.o. z siedzibą w Warszawie (kod pocztowy
        01-793), przy ul. Ludwika Rydygiera 8, zarejestrowaną przez Sąd Rejonowy
        dla M. St. Warszawy w Warszawie, XII Wydział Gospodarczy Krajowego
        Rejestru Sądowego, NIP: 118-00-15-209, Regon: 012125650, do przekazania
        następujących informacji o sposobie przetwarzania danych osobowych:
      </p>
      <p>
        ...
        Trading prosimy o wysłanie wiadomości pod adres: Dobopack@kolory.com lub
        kontakt pod numerem telefonu: +48 507-033-685.
      </p>
      <p>Dobopack Trading zbiera następujące informacje podane dobrowolnie:</p>
      <ul>
      ...
      <p>
        Podanie tych danych nie jest wymagane przepisami prawa, niemniej odmowa
        ich podania może uniemożliwić zawarcie umowy sprzedaży oferowanych przez
        nas dodatków spożywczych.
      </p>
      <p>
      ...
      <p>
        ...
        Zaprzestaniemy przetwarzania danych w momencie zajścia najpóźniejszego z
      ...
      <ul>
        <li>prawo do uzyskania informacji o sposobie przetwarzania danych,</li>
