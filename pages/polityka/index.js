  ...
  return (
    <Section className={classes.wrapper}>
      ...
      <p>
        ...
        należącego do DT obowiązuje aktualna Polityka Prywatności znajdująca się
        na tej stronie.
      </p>
      ...
      <p>
        ...
        odnoszące się bezpośrednio do oferowanych przez nas dodatków barwiących
        i smakowo-zapachowych do produkcji, przede wszystkim spożywczej, ale
        również farmaceutycznej, kosmetycznej i chemii gospodarczej, (np. zmiany
        i wprowadzanie nowych pozycji do naszej oferty, promocje) oraz
      ...
      <p>
        ...
        identyfikujące go w sposób potrzebny do uproszczenia lub umorzenia danej
        operacji.
      </p>
      <p>
        Cookies są nieszkodliwe dla komputera i jego użytkownika oraz dla danych
        użytkownika.
      </p>
      <p>
